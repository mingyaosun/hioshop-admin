                ...
                <el-table :data="tableData" style="width: 100%" border stripe>
                    ...
                    <el-table-column prop="enabled" label="状态" width="110px">
                        <template scope="scope">
                            {{ scope.row.is_delete == 0 ? '启用中' : '已到期下线' }} </template>
                    </el-table-column>
                    <el-table-column label="操作" width="220px">
                        <template scope="scope">
                            <el-button size="small" @click="handleRowEdit(scope.$index, scope.row)">编辑</el-button>
                            <el-button plain size="small" type="danger" @click="handleRowDelete(scope.$index, scope.row)">删除
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
        ...
        <el-dialog :title="is_add? '添加':'编辑'" :visible.sync="dialog">
            <el-form :model="noticeData">
                <el-form-item label="内容:" label-width="120px">
                    <el-input class="el-input" v-model="noticeData.content" auto-complete="off" placeholder="请输入内容"></el-input>
                </el-form-item>
